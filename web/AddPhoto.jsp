  ...
  <div class="parlex-back">
    <div class="container">
      ...
      <div class="row mrgn30">
        <form method="post" action="addPhotoServlet" id="contactfrm" role="form"  enctype="multipart/form-data">
          <div class="col-sm-12">
            <div class="form-group">
          
                <input  id="submit" type="file" id="myFile" name="photo" multiple="multiple">
              <br>
