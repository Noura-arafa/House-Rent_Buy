                        ...
                        <div id="portfolio">
                            ...
                            <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
                                <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> 
                                    <% ArrayList<House> userHouses = new ArrayList<House>();
                                            userHouses = (ArrayList<House>)request.getAttribute("UserHouses");
                                    ...
                                    <figure class="effect-bubba">
                                        ...
                                        <figcaption>
                                            <h2><%= userHouses.get(i).getAdName() %></h2> 
                                            <a href="adsDetails.html" class="fancybox"> Edit </a>
                                            <a href="adsDetails.html" class="fancybox"> Delete </a>
