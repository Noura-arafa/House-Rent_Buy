...
public final class houseJSP_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h2>Trends</h2> \n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"adsDetails.html\" class=\"fancybox\">More details</a> \n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t</figcaption>\t\t\t\n");
      out.write("\t\t\t\t\t</figure> \n");
      out.write("\t\t\t\t\t\n");
