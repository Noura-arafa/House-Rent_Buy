...
public final class HomePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <ul>\n");
      out.write("              <li><a href=\"#\">Sub Deep 1</a></li>\n");
      out.write("              <li><a href=\"#\">Sub Deep 2</a></li>\n");
      out.write("            </ul>\n");
      out.write("          </li>\n");
      ...
      out.write("      \n");
      out.write("    </div>\n");
      out.write("    <div id = \"bigClass\" class=\"row flat\">\n");
      out.write("      \n");
      out.write("      \n");
      out.write("        \n");
      out.write("      </div>\n");
      ...
      out.write("                    $(\"#bigClass\").prepend('<div id =\"card\" class=\"col-lg-3 col-md-3 col-sm-6 col-xs-12 \"></div>');\n");
      out.write("                    $(\"#card\").prepend('<ul id = \"ulCard\" class=\"plan plan4\"></ul>');\n");
      out.write("\n");
      out.write("                    var adName = '<li class=\"plan-name\"> ' + houses[i][\"adName\"] + '</li>';\n");
      out.write("                    var price = '<li class=\"plan-price\"> ' + houses[i][\"price\"] + ' <strong>$39</strong> </li>';\n");
      out.write("                    var status = '<li>  Status <strong>' + houses[i][\"status\"] + '</strong> </li>';\n");
      out.write("                    var size = '<li> Size <strong>' + houses[i][\"size\"] + '</strong>  </li>';\n");
      out.write("                    var viewMore = '<li class=\"plan-action\"> <a href=\"#\" class=\"btn btn-danger btn-lg\">View More</a> </li>';\n");
      out.write("                    var deleteBtn = '<button name=\"submit\" type=\"submit\" class=\"btn btn-lg btn-primary\" id=\"submit\">Delete </button>';\n");
      out.write("                    var suspendBtn = '<button name=\"submit\" type=\"submit\" class=\"btn btn-lg btn-primary\" id=\"submit\"> Suspend</button>';\n");
      out.write("\n");
      ...
      out.write("            }});\n");
      out.write("            \n");
      out.write("//          $.get(\"HomePage\", null, function (houses) {\n");
      out.write("//              for (var i = 0; i < houses.length; i++)\n");
      out.write("//          }\n");
      out.write("        </script>\n");
      out.write("\n");
